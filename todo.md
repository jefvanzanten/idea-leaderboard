...
- [x] Reuse AddIdeaForm to edit an idea.
- [x] TODO: Empty container with text that there are no idea's in the database yet.
- [x] TODO: Show the cover image as thumb image after choosing the image with the ImagePicker
- [x] TODO: You can now choose between 0 and 5 stars for a rating
- [x] TODO: You can select images for the image album that are relevant to the idea/project
- [x] TODO: Save the Idea / Project to the database so it appears on the page.
